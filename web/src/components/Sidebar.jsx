...
export default function Sidebar({ isOpen, setIsOpen, role }) {
    const allMenuItems = [
        ...
        { name: "Sınıflar", icon: BookOpen, path: "/classes", roles: ["teacher"] },
        { name: "Sohbet", icon: MessageCircle, path: "/chat" },
        { name: "Raporlar", icon: BarChart3, path: "/reports" },
        { name: "Öğrenci Raporu", icon: BarChart3, path: "/student-reports/new", roles: ["teacher", "manager"] },
    ];
        ...
        <>
            ...
            >
                ...
                <div className="p-6 flex flex-col items-center border-b border-indigo-500">
                    ...
                    <h1 className="text-xl font-bold tracking-wide">SmartNexus</h1>
