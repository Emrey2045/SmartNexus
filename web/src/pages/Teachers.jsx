...
export default function Teachers() {
    ...
    // Öğretmen ekleme yetkisi kontrolü
    const canAddTeacher = ["manager", "admin"].includes(userRole);
    // Öğretmen silme yetkisi kontrolü (ekleme yetkisi olanlar silebilir)
    const canDeleteTeacher = canAddTeacher;
    ...
    const getRoleInfo = () => {
        if (userRole === "teacher") {
            ...
            return "Sadece kendi okulunuzun öğretmenlerini görebilirsiniz.";
        }
        return null;
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-8">
            ...
            {/* Yeni Öğretmen Ekleme Formu - Sadece manager ve admin görebilir */}
            {canAddTeacher && (
                <form
                    onSubmit={handleAdd}
